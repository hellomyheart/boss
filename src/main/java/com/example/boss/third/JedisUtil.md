...
public class JedisUtil {
    ...
    public class Hash {
         ...
         *
         * @param key  键
         * @param map  对应的hashMap键值对
         * @param time 设置过期的过期时间
         * @return 状态，成功返回OK
         */
        public String hmset(String key, Map<String, String> map, int time) {
            Jedis jedis = getJedis();
            String s = jedis.hmset(key, map);
            if (time > 0) {
                expire(key, time);
